package net.mcreator.copperarmortooldversion.item;
...
public abstract class CopperarmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 8, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("copper_armor_to_old_version:copper_armor_sound")), () -> Ingredient.of(new ItemStack(Items.COPPER_INGOT)),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("copper_armor_to_old_version:copper"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("copper_armor_to_old_version:copperarmor"), armorMaterial);
